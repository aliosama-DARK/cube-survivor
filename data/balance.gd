...
const CHARS := [
	{"name": "Soldier", "col": Color(0.36, 0.52, 0.34), "col2": Color(0.75, 0.80, 0.70), "role": "Tactician", "cost": 0, "hint": "",
		...
		"rname": "Heavy Machine Gun", "rdesc": "5s: unleash a giant machine gun - huge fire rate and damage (slower while firing)", "runlock": 7, "rcd": 60.0,
	...
	{"name": "Pyromancer", "col": Color(0.95, 0.42, 0.12), "col2": Color(1.0, 0.80, 0.25), "role": "Fire Mage", "cost": 400, "hint": "or 400 kills in a run",
		...
		"rname": "Burning Skulls", "rdesc": "7s: summon 3 flaming skulls that shoot fire at your foes", "runlock": 7, "rcd": 60.0,
	...
	{"name": "Shinobi", "col": Color(0.16, 0.20, 0.24), "col2": Color(0.30, 0.85, 0.55), "role": "Shadow Slayer", "cost": 250, "hint": "or reach Stage 3",
		...
		"rname": "Shadow Rush", "rdesc": "5s: unlimited dashes with dash damage and +10% damage (i-frames only while dashing)", "runlock": 7, "rcd": 60.0,
	...
	{"name": "Knight", "col": Color(0.52, 0.56, 0.66), "col2": Color(0.30, 0.50, 0.90), "role": "Blade Wall", "cost": 600, "hint": "or beat 3 bosses in a run",
		...
		"sig": "spinblade", "signame": "Blade Throw", "sigdesc": "Throws large piercing swords; twin blades still guard you up close",
		"qname": "Berserk", "qdesc": "5s: blades spin faster, +50% blade damage, +25% speed", "qcd": 15.0,
		"rname": "Giant Blade Storm", "rdesc": "5s: hurl bigger, faster, stronger piercing swords", "runlock": 7, "rcd": 60.0,
	...
	{"name": "Titan", "col": Color(0.60, 0.63, 0.72), "col2": Color(0.85, 0.60, 0.25), "role": "Fortress", "cost": 1000, "hint": "or win the campaign",
		...
		"rname": "Cataclysm Shockwave", "rdesc": "Smash the ground for a huge blast - clears commons, hurls elites", "runlock": 7, "rcd": 60.0,
	...
	{"name": "Gambler", "col": Color(0.92, 0.90, 0.86), "col2": Color(0.90, 0.20, 0.25), "role": "High Roller", "cost": 1200, "hint": "or reach Stage 5",
		...
		"rname": "Fate Gamble", "rdesc": "Roll fate: 50% +40% damage / 50% -40% damage for 30s (no stacking)", "runlock": 7, "rcd": 60.0,
...
const UPS := [
	...
	{"id": "frostorb","name": "Frost Orb",     "desc": "Icy orb: damage + slow (Lv2 bigger, Lv3 +orb, Lv4 icy burst)", "rar": 1, "max": 4, "cat": "Engine", "slot": "weapon", "tags": ["Utility", "AoE", "Damage"]},
	{"id": "fireorb", "name": "Fire Orb",       "desc": "Blazing orb: damage + burn (Lv2 longer burn, Lv3 +orb, Lv4 death blast)", "rar": 2, "max": 4, "cat": "Engine", "slot": "weapon", "tags": ["AoE", "Damage"]},
	{"id": "lightorb","name": "Lightning Orb",  "desc": "Charged orb zaps and chains to foes (Lv up: chains, rate, +orb, stun)", "rar": 2, "max": 4, "cat": "Engine", "slot": "weapon", "tags": ["Damage", "AoE"]},
	...
	{"id": "area",  "name": "AoE Mastery",     "desc": "+18% aura, blast, wave and orb size/range per rank", "rar": 1, "max": 3, "cat": "Foundation", "slot": "passive", "tags": ["AoE"]},
	...
	{"id": "bossdmg","name": "Elite Hunter",    "desc": "+25% damage to bosses and elites per rank", "rar": 1, "max": 2, "cat": "Effect", "slot": "passive", "tags": ["Boss", "Damage"]},
	{"id": "pulse", "name": "Kill Wave",       "desc": "Every 20 kills: a big shockwave damages and slows foes (Lv2: bigger/stronger)", "rar": 1, "max": 2, "cat": "Effect", "slot": "passive", "tags": ["AoE", "Damage", "Utility"]},
	{"id": "frtrail","name": "Frost Trail",    "desc": "Dashing leaves a frost trail that slows and burns-cold foes (Lv2: longer, more damage)", "rar": 1, "max": 2, "cat": "Effect", "slot": "passive", "tags": ["Dash", "Damage", "Utility"]},
	...
	{"id": "heavy", "name": "Heavy Impact",    "desc": "+40% damage",                   "rar": 2, "max": 1, "cat": "Engine", "slot": "passive", "tags": ["Damage", "Risk"],
		"draw": "-12% fire rate - 8% move speed"},
	{"id": "dstrike","name": "Double Strike",  "desc": "Attacks have a 16% chance per rank to strike twice", "rar": 2, "max": 2, "cat": "Engine", "slot": "passive", "tags": ["Damage"]},
	{"id": "execute","name": "Execution",      "desc": "+45% damage per rank to enemies below 25% HP", "rar": 2, "max": 2, "cat": "Effect", "slot": "passive", "tags": ["Damage"]},
	{"id": "multicast","name": "Multicast",    "desc": "Your Q has a 30% chance per rank to cast a second time", "rar": 3, "max": 2, "cat": "Engine", "slot": "passive", "tags": ["Utility", "Damage"], "min_stage": 2},
	{"id": "lifesteal","name": "Lifesteal",    "desc": "Heal 3% of weapon damage dealt (no overheal, reduced vs bosses)", "rar": 2, "max": 2, "cat": "Engine", "slot": "passive", "tags": ["Healing", "Sustain"], "min_stage": 2},
	...
	{"id": "gpow",  "name": "Gunpowder",       "desc": "+25% blast damage, +12% blast radius, and explosions may ignite (per rank)", "rar": 1, "max": 2, "cat": "Engine", "slot": "passive", "partner_of": "bomb", "tags": ["AoE", "Damage"]},
